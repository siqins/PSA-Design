...
if __name__ == '__main__':
    ...
    # Read data
    data_pd = pd.read_csv('Tset_all_descriptors.csv', low_memory=False)
    data_pd_temp = pd.read_csv('Tset_all_descriptors.csv', usecols=['RepeatUnitSMILES', 'PropertyValue', 'TestFreq', 'TestTemp'])
    # print(data_pd)
